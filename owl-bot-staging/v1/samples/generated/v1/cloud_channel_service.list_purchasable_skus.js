...
function main(customer) {
  // [START channel_v1_generated_CloudChannelService_ListPurchasableSkus_async]
  /**
  ...
  async function listPurchasableSkus() {
    // Construct request
    const request = {
      customer,
    };
  ...
  listPurchasableSkus();
  // [END channel_v1_generated_CloudChannelService_ListPurchasableSkus_async]
}
