...
describe('v1.CloudChannelServiceClient', () => {
    ...
    describe('importCustomer', () => {
        it('invokes importCustomer without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.channel.v1.ImportCustomerRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.importCustomer as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getCustomerRepricingConfig', () => {
        it('invokes getCustomerRepricingConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.channel.v1.GetCustomerRepricingConfigRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.channel.v1.CustomerRepricingConfig());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getCustomerRepricingConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createCustomerRepricingConfig', () => {
        it('invokes createCustomerRepricingConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.channel.v1.CreateCustomerRepricingConfigRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createCustomerRepricingConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateCustomerRepricingConfig', () => {
        it('invokes updateCustomerRepricingConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.channel.v1.UpdateCustomerRepricingConfigRequest());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateCustomerRepricingConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteCustomerRepricingConfig', () => {
        it('invokes deleteCustomerRepricingConfig without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteCustomerRepricingConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getChannelPartnerRepricingConfig', () => {
        it('invokes getChannelPartnerRepricingConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.channel.v1.GetChannelPartnerRepricingConfigRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.channel.v1.ChannelPartnerRepricingConfig());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createChannelPartnerRepricingConfig', () => {
        it('invokes createChannelPartnerRepricingConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.channel.v1.CreateChannelPartnerRepricingConfigRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateChannelPartnerRepricingConfig', () => {
        it('invokes updateChannelPartnerRepricingConfig without error', async () => {
            ...
            const expectedHeaderRequestParams = "channel_partner_repricing_config.name=";
            const expectedOptions = {
                otherArgs: {
                    headers: {
                        'x-goog-request-params': expectedHeaderRequestParams,
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteChannelPartnerRepricingConfig', () => {
        it('invokes deleteChannelPartnerRepricingConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.channel.v1.DeleteChannelPartnerRepricingConfigRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteChannelPartnerRepricingConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listCustomerRepricingConfigs', () => {
        it('invokes listCustomerRepricingConfigs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.channel.v1.ListCustomerRepricingConfigsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listCustomerRepricingConfigs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listChannelPartnerRepricingConfigs', () => {
        it('invokes listChannelPartnerRepricingConfigs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.channel.v1.ListChannelPartnerRepricingConfigsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listChannelPartnerRepricingConfigs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
